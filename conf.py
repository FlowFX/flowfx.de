...
BLOG_AUTHOR = "Florian Posdziech"  # (translatable)
BLOG_TITLE = "FlowFX"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://flowfx.de/"
...
NAVIGATION_LINKS = {
    ...
    #     ("/de/", "Blog"),
    #     ("/de/jetzt/", "Jetzt"),
    #     # ("/de/was-ich-mache/", "Was ich mache"),
    #     # ("/de/ueber-mich/", "Über mich"),
    #     ("/de/kontakt/", "Kontakt"),
    #  ),

    #"es": (
        #("/es/", "Blog (inglés/alemán)"),
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ myuser@myhostingprovider.com:~/flowfx.de/",
    ]
}
...
ROBOTS_EXCLUSIONS = ["/archive.html", "/hidden/*", "/de/blog/*"]
